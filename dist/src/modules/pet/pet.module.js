...
exports.PetModule = PetModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([pet_entity_1.Pet]), external_api_module_1.ExternalApiModule],
        controllers: [pet_controller_1.PetController],
        providers: [pet_service_1.PetService],
        exports: [pet_service_1.PetService, typeorm_1.TypeOrmModule],
    })
], PetModule);
